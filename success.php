...
$success_message = $_SESSION['success_message'] ?? 'Thank you for your donation!';
$user_name = '';
...
<head>
    <meta charset="UTF-8">
    <title>Payment Success | Cambridge Public Education and Welfare Trust</title>
        ...
        <div class="max-w-2xl mx-auto text-center">
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <div class="mb-6">
                    ...
                    <p class="text-lg text-gray-700 mb-6"><?= htmlspecialchars($success_message) ?></p>
                </div>

                <div class="bg-yellow-50 p-4 rounded-lg mb-6">
                    <p class="text-sm text-gray-600">Your donation will help us continue our mission of providing quality education and welfare support to underprivileged children in Bihar, India.</p>
                </div>

                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="index.php" class="bg-[#1a237e] text-white px-6 py-3 rounded-full hover:bg-blue-800 transition">Go to Home</a>
                    <a href="donations.php" class="bg-yellow-400 text-[#1a237e] px-6 py-3 rounded-full hover:bg-yellow-300 transition">View My Donations</a>
                    <a href="payment.php" class="border border-[#1a237e] text-[#1a237e] px-6 py-3 rounded-full hover:bg-gray-50 transition">Donate Again</a>
                </div>
            </div>
        </div>
    </main>
